...
# Async-only: once max concurrent active requests is first reached, let this many
# additional tokens complete before stopping and reporting metrics.
...
def _init_worker_per_token_stats(mode: str, enabled: bool, sampling_rate: float) -> None:
    ...
    _PER_TOKEN_STATS_F.write(
        "mode,worker,pid,ep_group_size,global_request_max_batch_size,attn_service_t,net_delay,"
