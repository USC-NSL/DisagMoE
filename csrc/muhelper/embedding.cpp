...
void Sampler::run() {
    this->recv_mq->bind(disagmoe::mq_endpoint_factory()(device_id, true, -1));
...
void Tokenizer::put_request(int req_id, int init_prefill_len, int max_output_len, torch::Tensor tensor, int dp_rank) {
