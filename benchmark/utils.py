...
def add_runtime_arguments(parser: ArgumentParser):
    ...
    parser.add_argument("--max-in-flight-per-rank", type=int, default=2, help="max concurrent NCCL transfers per destination rank (lower = more batching)")
...
def add_model_arguments(parser: ArgumentParser):
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        choices=["mixtral", "qwen3_235b", "qwen3_30b", "gptoss_120b"],
