...
----------------------------------
Run from sgpu0. The script is idempotent (safe to re-run).
...
-------------------------
Run from sgpu0 in ~/DisagMoE with disag12 active and Ray cluster running.
